...
export class StudentContestListStrategy extends ContestsPaginationService {
  constructor(
    ...
    super(
      contestsRepository,
      cursorPagination,
      new Logger(StudentContestListStrategy.name),
    );
  }
  ...
  protected buildFilterChain(
    ...
    const permissionFilter = new CourseFilter(alias);
